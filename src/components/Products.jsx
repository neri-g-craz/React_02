import './Products.css'
/*
- Comenté esta línea de código, porque fue la que usé en el ejemplo de props estructurados
...
const Products = ({img, name, description, price}) => {
    return (
         ...
         */}
         ...
         {/* Props estructurados. Puedo asignar diferentes propiedades a un div, sin tenr que generar muchos props, soamente usando la palabra reservada 'props' como parámetro de la función
        ...
        {/*Props desestructurado. Permite asignar datos de un objeto a una variable separada para que dicha variable pueda contener los datos provenientes del objeto.
